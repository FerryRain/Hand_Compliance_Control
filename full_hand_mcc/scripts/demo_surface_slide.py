                        ...
                        def build_suffix_horizon_candidate(
                            ...
                            def suffix_node_residual(
                                ...
                                *,
                                ...
                                interior_guard_m: float | None = None,
                            ) -> np.ndarray:
                                ...
                                active_guard_m = (
                                    solve_guard_m
                                    if interior_guard_m is None
                                    else float(interior_guard_m)
                                )
                                if (
                                    not np.isfinite(active_guard_m)
                                    or active_guard_m < task_guard_m
                                ):
                                    raise ValueError(
                                        "suffix solve guard must be finite and no smaller than the audit guard"
                                    )
                                ...
                                rows.append(
                                    strict_suffix_task_hinge_residual(
                                        ...
                                        interior_guard_m=active_guard_m,
                                        weight=(
                            ...
                            last_suffix_horizon_evidence = {
                                ...
                                "candidate_rollout_interior_polish_attempt_count": np.asarray(
                                    [
                                        getattr(
                                            candidate,
                                            "rollout_interior_polish_attempt_count",
