...
_LEAPHAND_XML = Path("./src/mjlab/asset_zoo/robots/xarm6_leap_hand/xarm6_leap_hand.xml")
...
def leaphand_palm_contact_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
