...
<main>
  ...
  <section>
    ...
    <p>模型严格为 <code>nq=nv=nu=23</code>。本轮最终判据使用 central palm mesh site，而不是偏置 body origin；四个真实 contact geoms 都位于 distal fingertip belly。</p>
    <img src="../local_review/natural_pose_audit.png" alt="Exact DP video t=2 second posture">
    <img src="../local_review/mount_center_audit.png" alt="Central palm mount audit">
  </section>
  ...
  <section>
    ...
    <video controls preload="metadata" src="../local_review/mcc_f_video.mp4"></video>
  </section>
  ...
  <section>
    ...
    <video controls preload="metadata" src="../local_review/mcc_h_video.mp4"></video>
...
def run_visual_demo(
  ...
  *,
  ...
  fr3_paths = (
    output_dir.parent / "local_review/natural_pose_audit.png",
    output_dir.parent / "local_review/mount_center_audit.png",
    output_dir.parent / "local_review/mcc_f_video.mp4",
    output_dir.parent / "local_review/mcc_h_video.mp4",
